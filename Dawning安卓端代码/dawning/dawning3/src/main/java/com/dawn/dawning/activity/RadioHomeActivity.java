...
//        StatusBarUtil.addAppBarPaddingTop(this);
        ...
        articleLogo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(RadioHomeActivity.this,ArticleHomeActivity.class);
                //启动
        ...
        meditationLogo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(RadioHomeActivity.this,ThinkHomeActivity.class);
                //启动
                startActivity(intent);
            }
        });
        diaryLogo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(RadioHomeActivity.this,DiaryHomeActivity.class);
                //启动
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_my_mix) {
            ...
            Intent intent =new Intent(RadioHomeActivity.this,ProgramMixActivity.class);
            //启动
            startActivity(intent);


        } else if (id == R.id.nav_meditation_record) {
            Intent intent =new Intent(RadioHomeActivity.this,meditationReport.class);
            //启动
            startActivity(intent);

        } else if (id == R.id.nav_mood_curve) {
            Intent intent =new Intent(RadioHomeActivity.this,moodReport.class);
            //启动
            startActivity(intent);


        } else if(id == R.id.action_settings){
            Intent intent =new Intent(RadioHomeActivity.this,setup.class);
            //启动
            startActivity(intent);
