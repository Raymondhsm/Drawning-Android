...
public class UpdateDiaryActivity extends AppCompatActivity {
    ...
    @Bind(R.id.update_diary_mood)
    TextView mUpdateDiaryTvMood;
    @Bind(R.id.update_diary_mood_value)
    EditText mUpdateDiaryEtMood;
    ...
    public static void startActivity(Context context, String title, String content, String tag, String mood) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.update_diary_fab_add:
                ...
                String mood = mUpdateDiaryEtMood.getText().toString();
