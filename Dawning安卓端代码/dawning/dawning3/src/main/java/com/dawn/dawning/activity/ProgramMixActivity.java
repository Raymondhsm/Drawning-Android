...
public class ProgramMixActivity extends AppCompatActivity {
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent(context, ProgramMixActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_program_mix);
...
//        StatusBarUtil.addAppBarPaddingTop(this);
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.recyclerView_program_mix);
        //设置布局管理器，控制布局效果
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ProgramMixActivity.this);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                Toast.makeText(ProgramMixActivity.this, "你点击的是:"+categories[pos], Toast.LENGTH_SHORT).show();
    ...
    public void initData(){
        HttpUtil.sendOkHttpGetRequest(HttpUtil.PROGRAM_MIX,null,
                new okhttp3.Callback(){
                    @Override
                    public void onFailure(Call call, IOException e) {
                        Log.i("response","failed");
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                mRecyclerAdapter = new ProgramRecommendedAdapter(ProgramMixActivity.this,mProgramList);
