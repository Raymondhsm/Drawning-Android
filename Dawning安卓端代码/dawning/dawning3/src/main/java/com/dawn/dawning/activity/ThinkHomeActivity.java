...
public class ThinkHomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articleLogo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(ThinkHomeActivity.this,ArticleHomeActivity.class);
                //启动
                startActivity(intent);
        ...
        radioLogo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(ThinkHomeActivity.this,RadioHomeActivity.class);
                //启动
                startActivity(intent);
            }
        });
        ...
        diaryLogo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(ThinkHomeActivity.this,DiaryHomeActivity.class);
                //启动
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_my_mix) {
            ...
            Intent intent =new Intent(ThinkHomeActivity.this,ProgramMixActivity.class);
            //启动
            startActivity(intent);


        } else if (id == R.id.nav_meditation_record) {
            Intent intent =new Intent(ThinkHomeActivity.this,meditationReport.class);
            //启动
            startActivity(intent);

        } else if (id == R.id.nav_mood_curve) {
            Intent intent =new Intent(ThinkHomeActivity.this,moodReport.class);
            //启动
            startActivity(intent);


        } else if(id == R.id.action_settings){
            Intent intent =new Intent(ThinkHomeActivity.this,setup.class);
            //启动
            startActivity(intent);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()) {
            case R.id.pic1:
                Intent intent10 = new Intent(ThinkHomeActivity.this,LocalMusicActivity.class);
                startActivity(intent10);
                break;
            case R.id.pic2:
                Intent intent11 = new Intent(ThinkHomeActivity.this,LocalMusicActivity.class);
                startActivity(intent11);
                break;
            case R.id.pic3:
                Intent intent12 = new Intent(ThinkHomeActivity.this,LocalMusicActivity.class);
                startActivity(intent12);
                break;
            case R.id.pic4:
                Intent intent13 = new Intent(ThinkHomeActivity.this,LocalMusicActivity.class);
                startActivity(intent13);
                break;
            case R.id.pic5:
                Intent intent14 = new Intent(ThinkHomeActivity.this,LocalMusicActivity.class);
                startActivity(intent14);
                break;
            case R.id.pic6:
                Intent intent15 = new Intent(ThinkHomeActivity.this,LocalMusicActivity.class);
                startActivity(intent15);
                break;
            case R.id.pic7:
                Intent intent16 = new Intent(ThinkHomeActivity.this,LocalMusicActivity.class);
